...
author: "Ray Sun"
date: "2024-09-10"
categories: ["Data Science", "Text Analysis", "NLP", "STM"]
format:
  html:
    toc: true
...
## 1. Natural Language Processing (NLP): Partisan Framing of Immigration in U.S. Presidential Speeches
**Methods Used**: Structural Topic Modeling (STM), Word Embeddings, Cosine Similarity, `quanteda`
...
### Party Immigration Stance
![Cosine Similarity Plot](project/text_analysis/immigrant.png)
